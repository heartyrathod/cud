...
<main class="cud-main">
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <?php require get_stylesheet_directory() . '/banner.php'; ?>
    <div class="entry-content cud-entry-content">
      <div class="container">
        <div class="cud-guide">
          <div class="row">
            <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
              <ul class="cud-guide-category">
                <li>
                ...
                ?>
                  <li>
                    <a href="<?php echo esc_url(get_category_link($term->term_id)); ?>" class="<?php echo ($term_id == $term->term_id ? 'cud-active' : '');  ?>">
                      <?php echo $term->name; ?>
                ...
                <div class="row">
                  ...
                  ?>
                      <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="cud-guide-list-item cud-main-guide">
                          <div class="row">
                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                              <div class="cud-guide-list-img">
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                              <div class="cud-guide-list-content">
                                <?php foreach ($cates as $cate) { ?>
                                  <a href="<?php echo esc_url(get_category_link($cate->term_id)); ?>" class="cud-category"><?php if (!empty($cate)) {
